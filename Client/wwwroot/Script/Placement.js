        ...
        "columns": [
            ...
            },
            {
                data: null, render: function (data, type, row) {
                    return "<td><div class='btn-group'> <button class='btn btn-info' id='BtnAcc' data-toggle='modal' data-target='#myModal' data-placement='top' title='Confirm' data-original-title='Confirmation' onclick=Confirm('" + row.id + "');><i class='fa fa-check'></i></button> <button class='btn btn-danger' id='BtnCancel' data-toggle='tooltip' data-placement='top' title='Cancel' data-original-title='Cancel' onclick=Cancel('" + row.id + "');><i class='fa fa-minus'></i></button> </div></td>";
                }
            },
        ]
    });
